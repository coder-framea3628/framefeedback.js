...
<div class="ff-logo" aria-hidden="true">
  <img src="https://framerusercontent.com/images/nqe8sytY941OUcgvF17Y9qLajUc.png" alt="Logo" style="width:100%;height:100%;object-fit:cover;border-radius:10px">
</div>
            <div class="ff-title">Frame | Avaliação</div>
            <div class="ff-sub">Diga o que achou do atendimento</div>
          </div>
        </div>
      ...
      <div id="ffReport" style="display:none; margin-top:10px; gap:8px; flex-direction:column;">
        ...
        <input class="ff-input" id="ffReportName" placeholder="Nome do atendente reportado" aria-label="Nome do atendente reportado">
        <input class="ff-input" id="ffReportProtocol" placeholder="Protocolo de atendimento do ocorrido (opcional)" aria-label="Protocolo de atendimento">
        <textarea class="ff-textarea" id="ffReportDesc" placeholder="Descreva o comportamento inadequado do agente"></textarea>
      </div>

      <textarea id="ffComment" class="ff-textarea" placeholder="Gostaria de adicionar algum detalhe? (opcional)"></textarea>
      <input id="ffEmail" class="ff-input" type="email" placeholder="Seu e-mail">
  ...
  <button class="ff-btn" id="ffSubmit" style="min-width:180px;">Enviar avaliação</button>
</div>
      </div>
      ...
      ffCard.innerHTML = `
        <div style="display:flex;flex-direction:column;align-items:center;gap:12px;padding:18px">
          ...
          <div style="margin-top:12px;width:100%;display:flex;gap:10px;justify-content:center">
            ...
            <a href="https://frameag.com/contato" class="ff-btn ghost">Central de ajuda</a>
          </div>
        </div>
      `;
      // small toast
